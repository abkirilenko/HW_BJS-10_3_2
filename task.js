...
compareArrays = (arr1, arr2) => {
  if (arr1.length === arr2.length) return arr1.every((number, index) => number === arr2[index])};
...
const arr = [ [1,2,3,234,65,2], [1,2,454.4,3425], [1,2,3], [1,2,3], [9,5,2,4], [1,2,3], [1,2,3,234,65] ];
